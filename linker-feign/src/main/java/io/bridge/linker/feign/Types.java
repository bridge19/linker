...
/**
 * Static methods for working build types.
 *
 * @author Bob Lee
 * @author Jesse Wilson
 */
public class Types {
   ...
   * IntegerSet}, the model for when supertype is {@code Set.class} is {@code Set<Integer>} and the
   * model when the supertype is {@code Collection.class} is {@code Collection<Integer>}.
   */
  ...
  /**
   * The WildcardType interface support multiple upper bounds and multiple lower bounds. We only
